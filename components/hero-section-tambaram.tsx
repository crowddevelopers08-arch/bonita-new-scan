...
interface HeroSectionTambaramProps {
  onStartScan: (data: FormData) => void
}

export function HeroSectionTambaram({ onStartScan }: HeroSectionTambaramProps) {
        ...
        <DialogContent className="border-primary/20 bg-card/95 backdrop-blur-xl sm:max-w-md">
          ...
          <form onSubmit={handleSubmit} className="mt-4 flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <Label htmlFor="hero-problem-tambaram" className="text-foreground">
                Select Your Concern
              </Label>
              <Select
                value={problem}
              ...
              >
                <SelectTrigger id="hero-problem-tambaram" className="border-border/50 bg-background/50 focus:border-primary focus:ring-primary">
